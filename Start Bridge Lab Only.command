...
export NANAMI_VOICE_ENGINE_HOME="$VOICE_ENGINE_HOME"
...
mkdir -p "$VOICE_ENGINE_HF_HOME"
export IRODORI_SPEAKER_HF_HOME="${IRODORI_SPEAKER_HF_HOME:-$VOICE_ENGINE_HF_HOME}"
...
export IRODORI_SPEAKER_PYTHON="${IRODORI_SPEAKER_PYTHON:-$IRODORI_PYTHON}"
